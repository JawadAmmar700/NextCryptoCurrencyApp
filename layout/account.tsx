  ...
  useEffect(() => {
    ;(async () => {
      if (user?.attributes.ethAddress) {
        ...
        web3Js.eth.getBalance(user?.attributes.ethAddress).then(balance => {
          setBalance(web3Js.utils.fromWei(balance, "ether").slice(0, 7))
        })
      }
    })()
    ...
    <div className=" flex flex-col space-y-4 py-1">
      <div className="flex items-center justify-between">
        ...
        {isAuthenticated && (
          <div
            onClick={() => logout()}
            className=" rounded-full border-2 border-orange-500 p-0.5 cursor-pointer"
          >
            <svg x="0" y="0" width="32" height="32" className="rounded-full">
              <rect
                ...
                width="32"
                height="32"
                transform="translate(2.77666878674684 -4.644651510687349) rotate(354.9 16 16)"
                fill="#C81474"
              ></rect>
              <rect
                x="0"
                ...
                width="32"
                height="32"
                transform="translate(15.596954851614168 13.75397334599962) rotate(49.6 16 16)"
                fill="#F26A02"
              ></rect>
              <rect
                x="0"
                ...
                width="32"
                height="32"
                transform="translate(-30.416787095311204 -3.728253426213669) rotate(331.1 16 16)"
                fill="#FB1891"
              ></rect>
            </svg>
          </div>
      ...
      {isAuthenticated ? (
        <div className="w-full h-[120px] rounded-lg p-2 bg-[#312840] flex flex-col space-y-3  justify-center">
          <div className="font-medium text-slate-200 flex items-center justify-between">
            <div>
              <h1 className="font-bold text-md">Wallet Address</h1>
            ...
            <div
              ...
              className="relative p-2 hover:bg-[#261E35] rounded-lg cursor-pointer"
            >
              <MdOutlineContentCopy className="text-slate-200 w-4 h-4" />
            </div>
          </div>
          <div className="font-medium text-slate-200">
            <h1 className="font-bold text-md">Balance</h1>
            <p className="text-xs font-medium">{balance} ETH</p>
          </div>
        </div>
      ) : (
        <div className="w-full h-[150px] flex-auto flex flex-col items-center justify-center font-bold text-slate-100 space-y-3 uppercase text-sm">
